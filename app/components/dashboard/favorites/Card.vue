...
<template>
  <article class="group relative flex w-full flex-col bg-T-50 p-4 lg:p-5">
    <div class="relative">
      <ProductImage :src="product.image" :alt="product.title" container-class="mx-auto w-[130px] rounded-[20px] bg-transparent" />
    ...
    <h3 class="line-clamp-2 mt-3 h-10 text-[13px] font-bold leading-[20px] text-T-900">
      {{ product.title }}
    </h3>
