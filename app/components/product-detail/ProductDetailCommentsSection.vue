  ...
  <section :id="props.id" :class="cn('flex w-full scroll-mt-24 flex-col gap-4 lg:scroll-mt-6', props.class)">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-2">
        ...
        <h2 class="text-[16px] font-bold text-T-900">
          <span class="lg:hidden">دیدگاه کاربران</span>
          <span class="hidden lg:inline">نظرات کاربران</span>
        </h2>
      </div>
      <!-- Mobile: open full comments sheet -->
      <button
        type="button"
    ...
    <div class="hidden grid-cols-[324px_1fr] items-start gap-9 lg:grid">
      ...
      >
        <div class="flex items-center gap-3">
          <span class="flex size-10 shrink-0 items-center justify-center overflow-hidden rounded-full bg-T-200 text-T-600">
            <IconUser v-if="!(comment.reply && !comment.isBuyer)" class="size-5" />
            <img
              v-else
